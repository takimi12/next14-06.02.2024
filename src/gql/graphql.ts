...
export type CollectionGetByIdQuery = { collection?: { id: string, name: string, products: Array<{ description: string, id: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> } | null };
...
export type GetProductByIdQuery = { product?: { name: string, description: string, price: number, images: Array<{ url: string }> } | null };
...
export type ProductGetReviewsByIdQuery = { product?: { reviews: Array<{ content: string, headline: string, email: string, name: string, rating?: number | null }> } | null };

export type ProductGetSimilarQueryVariables = Exact<{
  categoryName: Scalars['String']['input'];
}>;


export type ProductGetSimilarQuery = { products: Array<{ description: string, id: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export type GetSingleProductQuery = { product?: { name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, variants: Array<{ id: string, name: string, size: ProductSize, color: ProductColor } | {}> } | null };

export type ProductsGetAllPaginatedQueryVariables = Exact<{
  skip: Scalars['Int']['input'];
...
export type ProductsByNameQuery = { products: Array<{ id: string, name: string, description: string, price: number, images: Array<{ id: string, url: string }>, categories: Array<{ name: string, id: string }> }> };
...
export type ReviewPublushAddMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type ReviewPublushAddMutation = { publishReview?: { id: string } | null };
...
export const ProductGetSimilarDocument = new TypedDocumentString(`
  ...
  products(where: {categories_every: {_search: $categoryName}}, first: 4) {
    ...
    `) as unknown as TypedDocumentString<ProductGetSimilarQuery, ProductGetSimilarQueryVariables>;
export const GetSingleProductDocument = new TypedDocumentString(`
...
export const ReviewPublushAddDocument = new TypedDocumentString(`
    mutation ReviewPublushAdd($id: ID!) {
  publishReview(where: {id: $id}) {
    id
  }
}
    `) as unknown as TypedDocumentString<ReviewPublushAddMutation, ReviewPublushAddMutationVariables>;